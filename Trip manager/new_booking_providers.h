...
public:
    ...
    friend Booking;  // РЇРІРЅРѕ СЂР°Р·СЂРµС€Р°РµРј С„СѓРЅРєС†РёСЏРј РєР»Р°СЃСЃР° Booking РІС‹Р·С‹РІР°С‚СЊ private-С„СѓРЅРєС†РёРё РЅР°С€РµРіРѕ РєР»Р°СЃСЃР° FlightProvider
